		...
		<div className="space-y-6">
			<main className="mx-auto grid max-w-3xl grid-cols-6 gap-6 px-6 pt-16">
				...
				<div className="col-span-6 space-y-2 rounded-2xl bg-yellow-200 p-6 dark:bg-indigo-800 md:col-span-4">
					...
					<p>
						Hi. My name is Alistair, I'm a software engineer from the UK. I've been programming for
						as long as I can remember. I am currently super busy working on{' '}
					...
					<p>
						Beyond programming, I'm really into drum &amp; bass, and I'll often be found DJing or
						messing around in Ableton Live. Either that or I'll be out riding my Boosted Board.
					</p>
				</div>
